//
//  DAODiscoverListBaseClassBaseClass.swift
//
...
public final class DAODiscoverListBaseClassBaseClass: NSCoding {
  ...
  public var page: Int?
  public var results: [DAODiscoverListBaseClassResults]?
  ...
  public required init(json: JSON) {
    ...
    if let items = json[SerializationKeys.results].array { results = items.map { DAODiscoverListBaseClassResults(json: $0) } }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.results = aDecoder.decodeObject(forKey: SerializationKeys.results) as? [DAODiscoverListBaseClassResults]
